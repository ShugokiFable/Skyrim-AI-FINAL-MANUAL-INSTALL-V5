...
. (Join-Path $PSScriptRoot 'V5-Common.ps1')
$root = Get-V5PackRoot
...
if ($InstallAfter) {
  Write-V5Step "Running INSTALL-V5-AIO.ps1 -Mode BundledFirst (cache preferred via offline update)"
  & (Join-Path $root 'INSTALL-V5-AIO.ps1') -Mode BundledFirst
}
