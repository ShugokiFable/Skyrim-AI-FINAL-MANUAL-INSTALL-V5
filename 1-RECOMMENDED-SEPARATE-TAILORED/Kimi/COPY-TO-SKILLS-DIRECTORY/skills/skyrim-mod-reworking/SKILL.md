...
type: prompt
whenToUse: Orchestrate repair, modernization, compatibility work, or cleanup of an existing Skyrim mod while preserving behavior,
  save compatibility, ownership, and a reversible release history.
