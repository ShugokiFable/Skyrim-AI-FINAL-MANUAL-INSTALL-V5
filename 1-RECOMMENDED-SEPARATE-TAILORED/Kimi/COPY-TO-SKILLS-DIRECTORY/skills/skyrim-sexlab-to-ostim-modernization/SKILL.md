...
type: prompt
whenToUse: Migrate a fictional adult-only Skyrim mod from SexLab APIs and events to the exact installed OStim ecosystem while
  preserving gameplay semantics, explicit content, configuration, and save compatibility.
